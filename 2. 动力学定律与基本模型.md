...
= \int_V \rho \boldsymbol{F} \cdot \boldsymbol{v} dV + \oint_\Sigma \boldsymbol{p}_n \cdot \boldsymbol{v} d \Sigma - \oint_\Sigma q_n d \Sigma
$$

其中 $q_n$ 是单位面积传热量，即传热强度。

上式减去动能定理方程即可得：

$$
\int_V \rho \frac{du}{dt} dV
= \int_V \boldsymbol{P} : \nabla \boldsymbol{v} dV - \oint_\Sigma q_n d \Sigma
$$
